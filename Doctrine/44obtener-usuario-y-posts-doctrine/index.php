...
$dispatcher = FastRoute\simpleDispatcher(function(RouteCollector $r)
{
    ...
    $r->addRoute("GET", "/insert-post/{user_id}", ['Application\Controllers\HomeController', 'insertPost']);
    $r->addRoute("GET", "/find-user-with-posts/{user_id}", ['Application\Controllers\HomeController', 'findUserWithPosts']);
});
